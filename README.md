...
- Notebook support.
- Foreground colors with higher contrast.
- Highlighting consistent with the vim [version](https://github.com/sainnhe/gruvbox-material)
